...
return [
    ...
    */
    ...
    'resource_permission_prefixes_labels' => [
        'view' => 'Ver un registro es particular',
        'view_any' => 'Ver el listado de registros',
        'create' => 'Crear',
        'update' => 'Actualizar',
        'delete' => 'Eliminar un registro es particular',
        'delete_any' => 'Eliminar varios registros a la vez',
        'force_delete' => 'Forzar elminación de un registro es particular',
        'force_delete_any' => 'Forzar eliminación de varios registros',
        'restore' => 'Restaurar un registro es particular',
        'reorder' => 'Reordenar',
